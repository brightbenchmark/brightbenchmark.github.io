...
[
    ...
    [
        '''                       <tr>
                       <td>
                          <p>{rank}</p>
                          <span class="date label label-default">Nov 13, 2025</span>
                       </td>
                              <td style="word-break:break-word;">
                                <a class="link" href="https://arxiv.org/abs/2508.07995">DIVER-v3-GroupRank</a>
    ...
    [
        '''                       <tr>
                       <td>
                          <p>{rank}</p>
                          <span class="date label label-default">Dec 12, 2025</span>
                       </td>
                              <td style="word-break:break-word;">
                                CRE-T1-SFT-preview-1202
                                <p style="font-size: 15;"> <i> CareerInternational Research Team </i> </p>
                              </td>
                       <td><b>28.0</b></td>
                    </tr>''',
        {
    ...
    [
        '''                       <tr>
                       <td>
                          <p>{rank}</p>
                          <span class="date label label-default">Apr 1, 2026</span>
                       </td>
                              <td style="word-break:break-word;">
                                <a class="link" href="https://huggingface.co/ForwardAILabs/MRE-T1">MRE-T1</a>
